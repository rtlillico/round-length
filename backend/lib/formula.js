...
function processHistoricalData(siloData, pastureKey, targetLeaves, soilType = 'sandyLoam', ifdData = null) {
  ...
  for (let doy = 1; doy <= 365; doy++) {
    ...
    percentileRows.push({
      ...
      tminP10: percentile(sTmin, 10), tminP25: percentile(sTmin, 25), tminP50: percentile(sTmin, 50),
      tminP75: percentile(sTmin, 75), tminP90: percentile(sTmin, 90),
      tmaxP10: percentile(sTmax, 10), tmaxP25: percentile(sTmax, 25), tmaxP50: percentile(sTmax, 50),
      tmaxP75: percentile(sTmax, 75), tmaxP90: percentile(sTmax, 90),
