...
export default function TemperatureScreen({ scenario, chartData, loading, onNavigate }) {
  ...
  function ds1main() {
    ...
    if (v.p50)       ds.push({ type: 'line', data: toXY(larP50),    borderColor: '#c49a20', borderWidth: 1,   pointRadius: 0, borderDash: [8, 4], yAxisID: 'yR' });
    return ds;
  }
  function ds2main() {
  ...
  function ds1zoom(win, pw) {
    ...
    if (v.p50) ds.push({ type: 'line', data: toXYWin(larP50, win.start, win.end), borderColor: '#c49a20', borderWidth: 1.5, pointRadius: 0, borderDash: [8, 4], yAxisID: 'yR' });
    return ds;
  }
          ...
          {!loading && (
            <>
              ...
              <ToggleBar show={visC1} onToggle={k => setVisC1(p => ({ ...p, [k]: !p[k] }))} items={[
                ...
                { key: 'p50',       label: 'P50 average',       color: '#c49a20' },
              ]} />
